...
def get(playername,step):
    ...
    print(question)
    return render_template("Game.html", player = playername, question = question, lifelines = lifelines_list, step=step_counter)
...
def Game(player,question):
    ...
    print(question)
    return render_template("Game.html", question = question, lifelines = lifelines_list, player = player, step=step_counter)
